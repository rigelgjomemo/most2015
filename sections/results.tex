...
The evaluation detected paths from sources to sinks in 29 of the 64 applications. Out of these 29 applications, the string solver was able to produce $V_I$ exploit strings for 26 of them. {\color{orange} These exploits were manually tested and confirmed}. \todo{W2.1.} We divide these vulnerabilities according to the class of UI elements that can be targeted by an attacker:
\begin{itemize}
...
A phishing attack scenario consists in presenting to the user a crafted web page resembling Mint's look and feel inside the application. \todo{W2.7}
